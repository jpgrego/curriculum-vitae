...
\item{\cventry{Novembro 2016 -- Presente}{Técnico Superior}{Universidade de
      Aveiro}{Aveiro}{Área de Plataformas Abertas}{Faz parte de uma equipa
      ...
      {universidadeaveiro/moodle-mosh-scripts}). Para além disso, mantém uma
      máquina GNU/Linux de testes pertencente ao grupo. Antes de ingressar nesta
      equipa, esteve responsável pelo desenvolvimento do \textit{backoffice} da
      aplicação móvel relativa ao projecto ``IES + Perto'', melhorando serviços
      já existentes e criando novos. Esteve também responsável pela melhoria de
      funcionalidades e correcção de \textit{bugs} numa aplicação para o sistema
      operativo móvel \textit{Android} para os vigilantes do \textit{campus}
      universitário. Esta última atribuía rondas a serem desempenhadas,
      \textit{check-in} de pontos-chaves, envio de fotografias de ocorrências a
      registar e emissão de alertas. Elabora frequentemente documentação em
      LaTeX e LibreOffice, descrevendo os passos para instalar certas
      plataformas e instalação de ambientes de desenvolvimento.}}
...
\item{\cventry{2008 -- 2019}{Mestrado Integrado em Engenharia de Computadores e
